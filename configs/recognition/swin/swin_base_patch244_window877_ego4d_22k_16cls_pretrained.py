...
num_cls=16
model=dict(backbone=dict(patch_size=(2,4,4), drop_path_rate=0.0,pretrained2d=False), test_cfg=dict(max_testing_views=2),cls_head=dict(num_classes=num_cls,loss_cls=dict(type='DeltaLoss')))
...
work_dir = './work_dirs/ego4d_swin_16cls_delta_best'
