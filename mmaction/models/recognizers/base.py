...
class BaseRecognizer(nn.Module, metaclass=ABCMeta):
    ...
    def forward(self, imgs,samp_rate=None, label=None, return_loss=True, **kwargs):
        ...
        if return_loss:
            ...
            return self.forward_train(imgs, label,samp_rate, **kwargs)
        #CE:I'll have to change this for test (include the samp_rate)
        
        return self.forward_test(imgs,samp_rate)#,**kwargs)
    ...
    def train_step(self, data_batch, optimizer, **kwargs):
        ...
        samp_rate = data_batch['samp_rate']
        ...
        losses = self(imgs,samp_rate, label, return_loss=True, **aux_info)
